export default function(THREE){
 ...
 head(0xd1aa39,[ellipse(-.27,.27,.205,.26),ellipse(.28,.25,.215,.26),ellipse(0,-.32,.29,.22)],.69,.68);
 eye(-.27,.27,.205,.26,{color:C.pink});eye(.28,.25,.215,.26,{color:C.pink,pupil:false});
 shape([[-.48,-.08],[-.40,.12,-.18,.16,0,.08],[.20,.16,.48,.08,.49,-.09],[.25,-.02,.08,-.08,0,-.13],[-.22,-.05,-.38,-.05,-.48,-.08]],0xb86428,.27,.23,.025);
 mouth(0,-.33,.29,.21,0xa44b27);ball(.17,.075,.08,0xb9664c,0,-.39,.26);cheek(-.48,-.12,0xc27b39);cheek(.49,-.14,0xb77833);
 shape([[-.14,.59],[-.20,.90,-.03,.89,-.01,.72],[.07,.98,.18,.91,.13,.68]],C.bone,.12,.08);
 crack([[.31,.66,.27],[.20,.51,.285],[.24,.39,.29],[.17,.27,.30],[.22,.05,.29],[.37,-.04,.29]]);chip(-.40,.51,.259,.10);chip(.39,-.48,.258,.07);bolts(-.54,-.32);bolts(.53,-.31);
