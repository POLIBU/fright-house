export default function(THREE){
 ...
 head(0x85957e,[ellipse(-.20,.21,.14,.095),ellipse(.20,.21,.14,.095),ellipse(0,-.38,.23,.14)],.48,.77);
 eye(-.20,.21,.14,.095,{color:C.ink,pupil:false});eye(.20,.21,.14,.095,{color:C.ink,pupil:false});brow(-.21,.40,.16,C.ink,1);brow(.21,.40,.16,C.ink,-1);
 ball(.064,.23,.12,C.bone,0,.00,.25);tube([[-.24,-.44,.29],[0,-.27,.31],[.24,-.44,.29]],.040,C.red);
 for(const s of [-1,1]){tube([[s*.23,.11,.28],[s*.26,-.04,.30],[s*.25,-.17,.29]],.012,C.ink);ball(.029,.055,.022,C.ink,s*.25,-.18,.29);cheek(s*.32,-.12,C.bone,.12,.15);}
 chip(-.25,.57,.27,.10);chip(.18,-.63,.26,.07);crack([[.29,.54,.28],[.23,.42,.28],[.30,.25,.27]]);
