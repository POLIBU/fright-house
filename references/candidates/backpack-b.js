...
rounded(.34,.43,.15,0x315953,0,.025,0,'fabric',.09);rounded(.36,.20,.04,0x264c49,0,.30,.085,'fabric',.055);rounded(.27,.16,.055,0x41675b,0,.065,.10,'fabric',.035);for(const x of [-.12,.12]){rod([x,.06,.13],[x,.45,.13],.011,0x684736,'fabric');box(.037,.045,.013,0x9b8150,x,.32,.149,'metal');const strap=torus(.14,.015,0x887442,x,.25,-.09,Math.PI*2,'fabric');strap.scale.x=.45;}torus(.055,.010,0x385d52,0,.475,0,Math.PI,'fabric');box(.19,.009,.01,0x9a8150,0,.195,.135,'metal');
