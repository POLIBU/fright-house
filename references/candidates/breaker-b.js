...
g.userData.mounts='back';rounded(.48,.72,.17,0x46635c,0,0,0,'metal',.035);rounded(.43,.65,.025,0xc0b799,0,.035,.096,'metal',.02);for(let i=0;i<3;i++){torus(.052,.014,0x7d7856,0,.16+i*.19,.123);rod([0,.16+i*.19,.13],[.047,.195+i*.19,.20],.018,[0x71312f,0xbb8d42,0x244d4c][i]);}for(const x of [-.19,.19])for(const y of [.07,.65])ball(.012,.012,.009,0x8f835c,x,y,.122,'metal');rod([0,.72,0],[0,.80,0],.03,0x4d6359);
