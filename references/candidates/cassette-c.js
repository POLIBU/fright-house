...
box(.105,.067,.014,0x273c33,0,.0335,0,'metal');for(const s of [-1,1]){box(.089,.03,.002,0xb5a786,0,.039,s*.008);for(const x of [-.024,.024]){const m=mesh(new THREE.CylinderGeometry(.009,.009,.007,12),0x21352b,x,.039,s*.010,'metal');m.rotation.x=Math.PI/2;}box(.07,.01,.003,0x9e8762,0,.008,s*.009);for(const x of [-.046,.046])for(const y of [.007,.06])torus(.002,.0008,0x99835c,x,y,s*.009);}
