export default function(THREE){
 ...
 shape([[-.55,-.50],[-.78,-.20,-.72,.19,-.55,.40],[-.65,.93],[-.15,.64],[.13,.66],[.64,.96],[.60,.37],[.84,.0,.64,-.51,.31,-.60],[0,-.77,-.31,-.63,-.55,-.50]],C.blue,.04,.19,.04,[ellipse(-.28,.26,.19,.28),ellipse(.27,.26,.19,.28),ellipse(0,-.35,.31,.23)]);
 shape([[-.57,.50],[-.57,.80],[-.28,.61]],C.pink,.28,.008,.01);shape([[.29,.62],[.57,.82],[.54,.48]],C.red,.28,.008,.01);
 eye(-.28,.26,.19,.28,{color:C.rust,pupil:false});eye(.27,.26,.19,.28,{color:C.rust,wink:true});
 cheek(-.17,-.11,C.bone,.22,.16);cheek(.17,-.11,C.bone,.22,.16);shape([[-.12,.02],[.12,.02],[0,-.10]],C.ink,.41,.055,.02);
 mouth(0,-.36,.30,.22,C.rust);ball(.15,.08,.075,C.pink,.04,-.46,.25);for(const s of [-1,1]){tooth(s*.21,-.22,.07,.16);for(let i=0;i<3;i++){bolts(s*(.22+i*.05),-.13+(i%2)*.08,.40);tube([[s*.25,-.1+i*.06,.38],[s*.47,-.13+i*.13,.33],[s*.63,-.13+i*.14,.28]],.007,C.ink);}}
 crack([[-.46,.59,.28],[-.38,.47,.28],[-.46,.34,.28],[-.40,.16,.28]]);chip(.43,-.35,.29,.10);chip(-.53,-.23,.29,.12);bolts(0,.53);
