export default function(THREE){
 ...
 shape([[-.48,-.36],[-.74,.0,-.46,.60,.02,.57],[.31,.61,.55,.20,.49,-.28],[.19,-.64,-.16,-.55,-.48,-.36]],0x498b80,.035,.17,.04,[ellipse(-.20,.23,.21,.23),ellipse(.23,.21,.16,.19),ellipse(.10,-.28,.21,.22)]);
 eye(-.20,.23,.21,.23,{color:C.gold});eye(.23,.21,.16,.19,{color:C.gold,pupil:false});mouth(.1,-.28,.21,.22,0xc98759);
 shape([[-.55,.14],[-.86,.34],[-.80,-.15],[-.55,-.23]],C.red,.06,.06,.01);shape([[-.22,.55],[-.11,.84],[.06,.68],[.22,.80],[.31,.5]],C.red,.08,.07,.02);
 for(let i=0;i<4;i++)tube([[-.48+i*.045,.05,.26],[-.43+i*.045,-.09,.29],[-.40+i*.045,-.20,.26]],.014,C.ink);
 chip(.35,.37,.26,.07);crack([[-.35,.49,.25],[-.45,.38,.27],[-.38,.21,.27]]);
