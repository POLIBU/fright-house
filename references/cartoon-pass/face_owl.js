export default function(THREE){
 ...
 shape([[-.50,-.43],[-.68,.05,-.46,.56,-.52,.76],[0,.49],[.53,.76],[.44,.45,.72,.05,.50,-.44],[0,-.64]],0x836553,.03,.16,.04,[ellipse(-.25,.18,.20,.23),ellipse(.25,.18,.20,.23)]);
 for(const s of [-1,1]){rim(s*.25,.18,.27,.29,C.bone,.24,.06);eye(s*.25,.18,.20,.23,{color:C.gold,pupil:s<0});brow(s*.25,.46,.22,C.ink,s);for(let j=0;j<4;j++)tube([[s*(.36-j*.04),-.16-j*.09,.25],[s*.17,-.24-j*.07,.28],[s*.06,-.20-j*.08,.25]],.018,C.bone);}
 shape([[-.085,.10],[.10,.10],[0,-.20]],C.gold,.29,.16,.025);chip(-.44,-.16,.24,.06);crack([[.31,.65,.24],[.35,.48,.26],[.28,.37,.26]]);
