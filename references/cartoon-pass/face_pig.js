export default function(THREE){
 ...
 head(0xa77d79,[ellipse(-.23,.18,.12,.10),ellipse(.23,.18,.12,.1),ellipse(0,-.35,.25,.10)],.59,.54);
 for(const s of [-1,1]){shape([[s*.34,.42],[s*.65,.69],[s*.60,.19]],C.pink,.09,.09,.02);eye(s*.23,.18,.12,.10,{color:C.rust});brow(s*.24,.34,.14,C.red,-s);}
 ball(.28,.16,.16,0xbc9390,0,-.05,.31);for(const s of [-1,1])ball(.052,.075,.012,C.ink,s*.10,-.05,.468);mouth(0,-.34,.25,.10,C.rust);tooth(-.1,-.32,.09,.055);tooth(.03,-.32,.10,.058);cheek(-.41,-.17,C.red);cheek(.40,-.17,C.red);
 chip(-.33,.40,.275,.10);crack([[.37,.33,.26],[.41,.12,.27],[.33,-.02,.28]]);bolts(-.52,-.02);bolts(.51,-.02);
