export default function(THREE){
 ...
 head(C.bone,[ellipse(-.22,.19,.14,.19),ellipse(.22,.19,.14,.19),ellipse(0,-.32,.22,.16)],.51,.55);
 shape([[-.39,.38],[-.55,1.22,-.13,1.28,-.10,.49]],C.bone,.04,.14,.03);shape([[.10,.48],[.22,1.31,.66,1.12,.42,.78],[.30,.81],[.32,.51]],C.bone,.04,.14,.03);
 shape([[-.32,.55],[-.40,1.03,-.24,1.09,-.21,.56]],C.pink,.235,.018,.008);shape([[.21,.56],[.29,.96,.43,1.01,.38,.82],[.24,.72]],C.pink,.23,.015,.008);
 eye(-.22,.19,.14,.19,{color:C.red});eye(.22,.19,.14,.19,{color:C.red,pupil:false});cheek(-.16,-.14,0xc4bca0,.17,.13);cheek(.16,-.14,0xc4bca0,.17,.13);ball(.085,.055,.09,C.pink,0,-.08,.37);mouth(0,-.34,.22,.16,C.rust);tooth(-.048,-.28,.078,.20);tooth(.048,-.28,.078,.20);
 crack([[.42,.33,.28],[.33,.13,.285],[.40,-.02,.28],[.30,-.17,.28]]);chip(-.30,-.36,.26,.09);bolts(-.39,.02);bolts(.39,.03);
