export default function(THREE){
 ...
 head(0xb98965,[ellipse(-.20,.21,.145,.12),ellipse(.20,.21,.145,.12),ellipse(0,-.34,.23,.105)],.50,.58);
 shape([[-.34,.45],[-.30,1.02],[.31,1.02],[.37,.45]],C.ink,.03,.24,.035);box(.69,.12,.27,C.red,0,.56,.16);ball(.56,.07,.20,C.ink,0,.48,.19);for(let i=0;i<3;i++)chip(-.20+i*.19,.92,.302,.025);
 eye(-.20,.21,.145,.12,{color:C.bone});eye(.20,.21,.145,.12,{color:C.bone});brow(-.20,.36,.16,C.ink,-1);brow(.20,.36,.16,C.ink,1);ball(.09,.13,.16,0xa46951,0,.02,.31);mouth(0,-.35,.23,.10,C.red);
 for(const s of [-1,1])tube([[0,-.16,.38],[s*.18,-.09,.36],[s*.32,-.16,.31],[s*.38,-.07,.29]],.055,C.ink);
 crack([[-.40,.24,.26],[-.34,.06,.28],[-.42,-.10,.27]]);chip(.33,-.28,.27,.07);bolts(0,-.52);
