export default function(THREE){
 ...
 for(let i=0;i<13;i++){const a=i/13*Math.PI*2;const p=shape([[-.1,.52],[.02,.89],[.13,.52]],i%2?C.gold:0xb36b35,.045,.08,.013);p.rotation.z=a;}
 head(C.gold,[ellipse(-.20,.17,.14,.11),ellipse(.20,.17,.14,.11),ellipse(0,-.26,.25,.10)],.51,.53);
 eye(-.20,.17,.14,.11,{color:C.rust});eye(.20,.17,.14,.11,{color:C.rust});brow(-.20,.31,.16,C.rust);brow(.20,.31,.16,C.rust);
 ball(.06,.17,.12,0xc2973c,0,.01,.25);mouth(0,-.27,.25,.1,C.red);for(let i=-2;i<=2;i++)tooth(i*.076,-.24,.067,.057);cheek(-.31,-.09,0xb37442);cheek(.31,-.09,0xb37442);
 crack([[.29,.40,.27],[.18,.31,.28],[.23,.20,.28]]);chip(-.25,-.35,.27,.055);
