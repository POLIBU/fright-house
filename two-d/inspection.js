...
export function createInspector({onClose}){
  ...
  function transform(z=1,center=[.5,.5]){zoom=z;image.style.transform=`translate(${(0.5-center[0]*z)*100}%, ${(0.5-center[1]*z)*100}%) scale(${z})`;$('#inspect-hotspots').hidden=z!==1;}
  ...
  $('#inspection-close').onclick=close;$('#inspect-fit').onclick=fit;
