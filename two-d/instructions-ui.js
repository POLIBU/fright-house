...
export function installInstructions(){
 ...
 d.querySelector('button').onclick=()=>d.close();d.onclose=()=>{if(resume)document.querySelector('#pause')?.click();delete d.dataset.keepMusic;resume=false;};
}
