...
export function endingHint(branch){return branch==='arrest'?'Try collecting fewer secret items for an alternative ending.':'To unlock the alternative ending, collect all the items dropped by the children.';}
