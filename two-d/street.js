...
function paper(){ctx.save();ctx.shadowColor='#ffe4a6';ctx.shadowBlur=2;ctx.translate(63,242);ctx.rotate(-.25);rect(-8,-4,18,11,'#392e21aa');rect(-9,-5,18,10,'#c0ac79');rect(-8,-4,16,2,'#4c4030');line(0,-1,0,4,'#776243');for(let j=0;j<3;j++){rect(-7,-1+j*2,6,1,'#796647');rect(2,-1+j*2,5,1,'#796647');}ctx.restore();}
