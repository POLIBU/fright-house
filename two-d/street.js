...
const sound={ambience:new Audio('../audio/ambience.mp3'),music:new Audio('./audio/atlas-eerie-mystery.mp3'),mechanism:new Audio('../audio/wall.mp3'),gateClose:new Audio('../audio/wall.mp3')};sound.music.loop=true;sound.music.volume=.18;sound.music.preload='none';sound.ambience.loop=true;sound.ambience.volume=.2;sound.mechanism.volume=.22;sound.gateClose.volume=.58;sound.gateClose.preload='auto';const resumeSounds=new Set();
