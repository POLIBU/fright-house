...
export function installTouchJoystick(){
 ...
 const stick=document.createElement('div');stick.id='touch-joystick';stick.setAttribute('role','group');stick.setAttribute('aria-label','Movement joystick. Drag to move; release to stop.');
